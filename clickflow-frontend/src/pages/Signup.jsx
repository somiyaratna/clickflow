...
const Signup = () => {
  ...
  async function handleSignup(e) {
    ...
    try {
      const signupData = await userSignup({
        ...formData,
        phoneNo: `${countryCode}-${formData.phoneNo}` // Combine code + number
      });
  ...
  return (
    <div
      className="font-roboto min-h-screen w-full flex flex-col items-center justify-center gap-16 bg-cover bg-center bg-[#925FFF] overflow-y-auto pt-24 md:pt-0"
    >
      {/* LOGO */}
        ...
        <form className="block flex-grow" onSubmit={handleSignup}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            ...
            <Input
              ...
              onChange={handleChange}
            />
            <div className="flex flex-col mb-1 md:mb-2 text-left relative">
              <label htmlFor="phoneNo" className="text-sm md:text-base block mb-1 font-normal text-[#14213D]">Phone Number</label>
              <div className="flex">
                <select
                  className="rounded-l-lg border border-bg800 w-28 outline-none border-r-0 text-[#14213D] bg-[#EFF3FB] text-base px-2 transition-all duration-300 focus:border-primary500 focus:shadow-primary600 placeholder:text-[#14213D] placeholder:text-xs md:placeholder:text-base flex items-center"
                  value={countryCode}
                ...
                <input
                  className={`w-full border border-l-0 bg-[#EFF3FB] text-[#14213D] border-bg800 outline-none rounded-r-lg px-2 py-1 md:px-4 md:py-2 text-base transition-all duration-300 focus:border-primary500 focus:shadow-primary600 placeholder:text-[#14213D] placeholder:text-xs md:placeholder:text-base flex items-center`}
                  type="text"
                  id="phoneNo"
