  ...
  return (
    <div className="bg-[#121e3a] grid grid-cols-1 sm:grid-cols-3 gap-4 p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
      ...
      <div className="text-center sm:text-right">
        <p className={`text-2xl font-bold ${userData?.wallet_balance < 0 ? 'text-red-500' : userData?.wallet_balance === 0 ? 'text-white' : 'text-green-500'}`}>USDT {userData?.wallet_balance}</p>
